    ...
    return (<>
        ...
        {selectedMealTitle == "" ? <div>
            <Row className="categoriesRow">
                {data?.data?.meals?.length > 0 ? data.data.meals.map((item) => {
                            ...
                            <Card className="">
                                ...
                                <Card.Body className="categoriesBody">
                                    ...
                                    {cartdata == undefined || cartdata == {} || cartdata.count == 0 ?
                                        <Button onClick={() => { handelMeals(item.strMeal) }} className="addtoCardButton" variant="primary">Add To Cart</Button>
                                        :
